...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  /// Set data source for playing a video from SRT (Secure Reliable Transport) stream.
  ///
  /// The SRT URL for the video is given by the [dataSource] argument and must not be
  /// null. SRT URLs typically start with 'srt://' or 'srt://host:port'.
  Future<void> setSrtDataSource(
    String dataSource, {
    Map<String, String?>? headers,
    bool? showNotification,
    String? title,
