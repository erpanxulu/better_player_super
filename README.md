...
- **Multiple video sources**: Network, file, asset, memory
...
- **Controls**: Customizable video controls
- **Picture in Picture**: PiP mode support
- **Notifications**: Media notification controls
- **Playlists**: Video playlist support
- **Resolutions**: Multiple video quality support
- **Buffering**: Configurable buffering settings
